...
def processDataset():
    ...
    text.insert(END,"20% images are used to test DenseNet169 : "+str(X_test.shape[0])+"\n")
...
font = ('times', 16, 'bold')
title = Label(main, text='Snake Species Identification & Recognition',anchor=W, justify=CENTER)
